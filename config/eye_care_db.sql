...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2025 at 03:34 PM
...
INSERT INTO `users` (`id`, `email`, `password`, `role`, `name`, `phone`, `created_at`, `email_verified`, `verification_code`) VALUES
(1, 'admin@admin.com', '$2y$10$1.2MUv1Gxf5XRRCMZ68eSugkpTnuhfabMJFtW99QzEeEfO24NiXD2', 'admin', 'Admin', '', '2025-03-26 16:45:13', 1, NULL),
(2, 'rapidnepal21@gmail.com', '$2y$10$BtQ2B9UKHzCPvMoel.1u2eJ.YXkZCWWirkQmNm7f06gSD9HFHGAv2', 'patient', 'Pramesh Rajkarnikar', '9841986396', '2025-03-27 12:55:39', 0, '823279'),
(3, 'pransaraj@gmail.com', '$2y$10$H.cmjdVlgJQLvlZjOj8Ip.1zqSrEiuPJHN6DeO/XQIkgJpSFEpFaC', 'patient', 'Pramesh Rajkarnikar', '9841986396', '2025-03-27 12:56:54', 0, '081376');
